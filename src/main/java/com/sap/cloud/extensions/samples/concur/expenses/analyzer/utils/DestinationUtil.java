...
public class DestinationUtil {
	...
	private static final String ERROR_PROBLEM_OCCURED_WHILE_INITIALIZING_CONTEXT_CONNECTIVITY_CONFIGURATION_IS_NULL = MessageFormat
			.format(ERROR_PROBLEM_OCCURED_WHILE_INITIALIZING_CONTEXT, "connectivity configuration is null");
	...
	static {
		try {
			...
			if (connectivityConfiguration == null) {
				logger.error(ERROR_PROBLEM_OCCURED_WHILE_INITIALIZING_CONTEXT_CONNECTIVITY_CONFIGURATION_IS_NULL);
				throw new RuntimeException(
						ERROR_PROBLEM_OCCURED_WHILE_INITIALIZING_CONTEXT_CONNECTIVITY_CONFIGURATION_IS_NULL);
			}
	 ...
	 *             when destination with the given name is not found.
	 */
